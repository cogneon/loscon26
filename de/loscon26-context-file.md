...
an der lernOS Convention. Die Badges können leider nicht mehr über
[Badgr](https://eu.badgr.com/) verteilt werden, weil der Dienst
eingesetellt wurde. Wir suchen nach einer Lösung. Für den Badge-Versand
werden die Email-Adressen verwendet, die bei der Anmeldung angegeben
wurden.
...
2.  Aufsteller "Infodesk" (plus weitere Aufsteller, die keine eigene
    Kiste haben)
3.  Für Ausgabe: Lanyard, Button, lernOS Smart Card
4.  McGyver Kit: Stifte, Scheeren, Postits, Klebeband
5.  Stickerbox
6.  nuedigital Merch
7.  Servietten für Abendessen
8.  Knabbereien, Süßigkeiten für Abends (nach Abendessen)
...
- Kurzdistanz-Beamer
- RaspberryPi mit Tastatur (Browser mit Fediwall und Social Network
  Diagram im Wechsel)
...
5.  **Video-Mixer** ATEM TV Studio + Web Presenter per USB-A an Docking
    Station
6.  4x **Funkstrecke** Sennheiser XSW per XLR an Audio Mixer (2x
    Nackenbügel, 2x Hand)
7.  **Audio Mixer** Zoom LiveTrak L8 (6xXLR in) per USB-A an Docking
    Station (Mix: Master, mix-minus für Teams) und per Klinke 6,5 mm an
    PA Eppeleinsaal (Mix: A)
8.  1x **Headset** Beyerdynamic DT297 (damit Benedikt mit online
    sprechen kann, ohne PA an)
9.  **iPod** (von Simon) für Musik auf Kanal 7/8 (tagsüber Moby, Abends
    loscon25)
...
Alle Teilnehmer:innen werden auf den loscon Discord-Server eingeladen.
...
![](./img/screenshot-discord.png)
  ...
  **Willkommen**      
  ...
  erste-schritte      Die wichtigsten Tipps für Discord-Newbies und der Link zur
  *(read only)*       [Discord Hilfe](https://support.discord.com/hc/de)

  vorstellungsrunde   Hier könnt ihr Euch mit Name, Organisation, Bild, Hashtags,
                      Links vorstellen. Im Kanal ist die das automatisch generierte
                      Soziale-Netzwerk-Diagramm angepinnt.

                      

  **Allgemein**       

  programm            Links zum [Programm](https://pretalx.com/loscon25/schedule/) und
  *(read-only)*       Teams-Einwahllinks für alle Räume
  ...
  **Satelliten**      Chat-Kanäle für die [loscon
                      Satelliten](https://loscon.lernos.org/de/loscon-everywhere/)
  ------------------------------------------------------------------------------------
...
Wer schon am Vortag (22.06.) da ist, kann zu unserem
**Vorabend-Treffen** kommen, das im Rahmen der Eröffnung des [Nürnberg
Digital Festivals](https://nuernberg.digital/) stattfindet
(Selbstzahler). Treffpunkt wird hier noch bekannt gegeben.
...
Na klar, einfach [im Ticketshop](https://pretix.eu/cogneon/loscon26/)
...
Das Programm findest Du unter <https://pretalx.com/loscon26/schedule/> -
...
Vorschläge für Lightning Talks, Vorträge und Workshops müssen über den
...
- **STREAM-KONTROLLE:** (optional) Wähle Dich mit Deinem eigenen PC in
  ...
  erleben kannst. Verwende ein Headset, damit Du auch den Ton hörst und
...
Repository](https://github.com/cogneon/loscon26) gepflegt. Die Quelle
...
Der **Aufbau** erfolgt am **22.06.** ab ca. 13:00 Uhr. Der **Abbbau**
erfolgt nach dem Abschluss der loscon am **24.06.2026 von 16:00 bis ca.
18:00 Uhr**. Für beides werden helfende Hände benötigt 🤗
...
verwenden. Die Zugangsdaten zum Netzwerk findet ihr auf den Aushängen in
der Lokation.

# Orga-Team

Das Orga-Team hat ab dem 30.01.2026 einen **wöchentlichen Orga-Call**
jeweils **Freitags von 10:05 - 10:55 Uhr** per MS Teams. Die Retro ist
am 11.07.2026. Ihr erreicht das Orga-Team oer Email unter
<loscon@lernos.org>.
...
- **Dokumentation:** [Wiki](https://github.com/cogneon/loscon26/wiki) im
  Github-Repo der loscon
- **Aufgabenverwaltung:**
  [Issues](https://github.com/cogneon/loscon26/issues) im Github-Repo
  der loscon
...
3.  [Brigitte Lüdecke](https://www.linkedin.com/in/brigitteluedecke/)
4.  [Christian
...
melden](mailto:loscon@lernos.org).
