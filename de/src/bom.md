...
*Verantwortlich: **Heidi**, Andja*

1. 2x iPod mit Pretix App und USB-Ladegerät
2. Aufsteller "Infodesk" (plus weitere Aufsteller, die keine eigene Kiste haben)
3. Für Ausgabe: Lanyard, Button, lernOS Smart Card
4. McGyver Kit: Stifte, Scheeren, Postits, Klebeband etc.
5. Stickerbox, Merch
6. Klebeband
7. Mehrfachsteckdose mit 2x USB-A
8. Verlängerungskabel orange
9. Aushänge Din A4
...
- Bühne: **Presenter PC** (Macbook von Simon von Simon)
- Mobiler **USB-C-Monitor** als 2nd Screen für Speaker
- Lightning Talk Lampe
- Maskottchen Suri (Stofftier + Kunststoff) inkl. Suris für 
- Kurzdistanz-Beamer
...
*Verantwortlich: **Benedikt**, Marcel, Magnus*
...
5. **Video-Mixer** ATEM TV Studio + Web Presenter per USB-A an Docking Station
6. 4x **Funkstrecke** Sennheiser XSW per XLR an Audio Mixer (2x Nackenbügel, 2x Hand)
7. **Audio Mixer** Zoom LiveTrak L8 (6xXLR in) per USB-A an Docking Station (Mix: Master, mix-minus für Teams) und per Klinke 6,5 mm an PA Eppeleinsaal (Mix: A)
8. 1x **Headset** Beyerdynamic DT297 (damit Benedikt mit online sprechen kann, ohne PA an)
...
## Coworking Eppeleinsaal und Deko
...
- Knabbereien, Süßigkeiten für Abends (nach Abendessen)
