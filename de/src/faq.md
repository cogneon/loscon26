...
??? question "**Was brauche ich zum Check-in vor Ort in Nürnberg?**"
...
??? question "**Was brauche ich zum digitalen Check-in?**"
...
??? question "**Wo finde ich mein elektronisches Ticket?**"
...
??? question "**Wo finde ich das Programm?**"
    Das Programm findest Du unter [Programm](program.md) oder als separate Seite unter [https://pretalx.com/loscon26/schedule/](https://pretalx.com/loscon26/schedule/) - am besten gleich zu den Favoriten hinzufügen oder über das Menü oben rechts im Kalender abonnieren (iCal).

??? question "**Wo finde ich die Teams-Einwahllinks?**"
    Die Teams-Einwahllinks stehen im Discord-Server im Kanal *#programm*.

??? question "**Wie werden die Lightning Talks, Sessions, Workshops für das Programm vorausgewählt?**"
...
??? question "**Brauchen Session-Geber*innen und Community-Assembly-Hosts auch ein Ticket?**"
...
??? question "**Gibt es ein Vorabend-Programm?**"
...
??? question "**Wann und wie erhalte ich die Einwahldaten?**"
...
??? question "**Brauche ich ein Microsoft-365-Konto zur Einwahl in Teams?**"
...
??? question "**Warum ist der Chat in Teams deaktiviert?**"
...
??? question "**Warum Microsoft Teams und Discord als Toolset?**"
...
??? question "**Wer ist Veranstalter der lernOS Convention?**"
    Veranstalter ist die Cogneon Akademie ([Impressum](https://cogneon.de/impressum)).

??? question "**Ich/meine Organisation will lernOS Supporter werden, was muss ich tun?**"
